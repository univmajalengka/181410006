<?php
//koneksi ke database
$koneksi = new mysqli("localhost", "root","", "sbdl_yuda");
?>
<!DOCTYPE html>
...
<head>
    ...
    <title>Free Bootstrap Admin Template : Busana</title>
	<!-- BOOTSTRAP STYLES-->
    ...
    <div id="wrapper">
        <nav class="navbar navbar-default navbar-cls-top " role="navigation" style="margin-bottom: 0">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="index.php">Busana</a> 
            </div>
           ...
           <!-- /. NAV TOP  -->
            ...
            <div class="sidebar-collapse">
				...
				<li class="text-center">
                    ...
                    <li><a href="index.php?halaman=transaksi"><i class="fa fa-dashboard fa-3x"></i>Transaksi</a></li>
                    <li><a href="index.php?halaman=notransaksi"><i class="fa fa-dashboard fa-3x"></i>No transaksi</a></li>
                ...
                if (isset($_GET['halaman']))
                {
                    ...
                    elseif ($_GET['halaman']=="transaksi")
                   {
                    include 'data_transaksi.php';
                     ...
                     elseif ($_GET['halaman']=="notransaksi")
                   {
                    include 'data_notransaksi.php';
                   }
